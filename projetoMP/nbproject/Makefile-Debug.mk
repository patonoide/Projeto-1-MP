...
# Test Object Files
TESTOBJECTFILES= \
	${TESTDIR}/testaArvore.o \
	${TESTDIR}/tests/testeJogo.o
...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/projetomp

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/projetomp: ${OBJECTFILES}
...
${TESTDIR}/testaArvore.o: testaArvore.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/testaArvore.o testaArvore.cpp


${TESTDIR}/tests/testeJogo.o: tests/testeJogo.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/testeJogo.o tests/testeJogo.cpp
...
${OBJECTDIR}/arvore_nomain.o: ${OBJECTDIR}/arvore.o arvore.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/arvore_nomain.o arvore.cpp;\
	else  \
...
${OBJECTDIR}/funcoes_nomain.o: ${OBJECTDIR}/funcoes.o funcoes.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/funcoes_nomain.o funcoes.cpp;\
	else  \
